...
export default function () {
  return (
    ...
    <main className="space-y-4 min-h-screen pb-20">
        ...
        <Container>
        <div className="w-full relative rounded-xl overflow-hidden max-w-[400px] aspect-video">
        ...
        <div className="">
          ...
          <div className="h1.5 border border-gray-200 dark:border-white/30 mx-2 mt-2"></div>
        </div>
        </Container>
        ...
        <div className="space-y-2">
            ...
            <div className="flex gap-5 text-center text-sm">
                <div className="px-6 py-2 ring-2 flex-1 dark:ring-white/20 ring-gray-200 rounded-xl">S</div>
                <div className="px-6 py-2 ring-2 flex-1 text-[#C67C4E] dark:ring-white/20 ring-[#C67C4E] rounded-xl">M</div>
                <div className="px-6 py-2 ring-2 flex-1 dark:ring-white/20 ring-gray-200 rounded-xl">L</div>
        ...
        {/* buy button */}
        <div className="flex px-4 gap-12 py-4 bg-white dark:bg-black  fixed bottom-0 w-full">
            <div className="">
